    ...
    <div class="flex items-center justify-between h-16">
      <div class="w-full flex justify-between">
        ...
        <div class="md:relative">
          ...
          {#if userMenuExpanded}
            <div
              class="origin-top-right absolute z-50 right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black/5 focus:outline-none"
              role="menu"
    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="ml-3 relative">
          ...
          <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
