...
<span
  class={mergeClassNames([
    "isolate inline-flex rounded-md w-full h-10 border-b shadow",
    classNames,
  ])}
>
  {#each items as item, index}
    <Button
      class={mergeClassNames([
        "relative inline-flex items-center text-sm font-semibold border border-b-0 flex-1 justify-center",
        {
